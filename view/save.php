<div class="container p-3">
    ...
    <div class="card p-0 m-2 mx-auto">
        ...
        <div class="card-body">
            <form action="?action=source" method="post">
                ...
                <div class="form-group">
                    Your email address if you want to be notified as soon as the level was included. You can also leave
                    this blank.
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="checkAgree">
                        I agree that the level I designed will be included in the app Flowit. I agree to publish the
                        level under the terms of the GPL-3 open-source license. Required.
                    </label>
                </div>
    ...
    <div class="alert alert-secondary">
        ...
        <a class="btn btn-primary" href="./?action=play&play=restart">Play Now</a>
    </div>
    <?php } ?>
</div>